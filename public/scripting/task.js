...
document.querySelector("#deleteuserbtn").addEventListener('click',async(event)=>{
    ...
    await axios({
        method:'delete',
        url:'http://localhost:4000/task/delete-user',
...
async function getAll() {
    ...
    try {
        ...
        const result = await axios.get(`http://localhost:4000/task/get-task/${itemsperpage}/${currentpage}`,{headers:{Authorazation:token}})
...
async function handleAddTask(event){
    ...
    try {
        ...
        const result= await axios.post('http://localhost:4000/task/add-task',taskObj,{headers:{Authorazation:token}});
...
function display(object){
    ...
    select.addEventListener('change',async(event)=>{
        ...
        await axios.patch('http://localhost:4000/task/update-task',obj,{headers:{Authorazation:token}});
    ...
    method:'delete',
    url:'http://localhost:4000/task/delete-task',
    data:object,
    headers:{Authorazation:token}})
